...
- multi-DET gene lists from isoform-level analysis
- cell-type pseudobulk DESeq2 results generated by `Integration_and_Pseudobulk_DESeq2.R`

For each cell type and comparison, enrichment was tested using:
